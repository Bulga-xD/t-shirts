...
export default function ReviewList({
  ...
  return (
    <div className="space-y-4">
      {reviews.length === 0 && <div>Няма отзиви</div>}
      {userId ? (
          ...
          <DialogContent className="sm:max-w-[425px]">
            <Form {...form}>
              <form method="post" onSubmit={form.handleSubmit(onSubmit)}>
                <DialogHeader>
                  <DialogTitle>Напишете отзив</DialogTitle>
                  <DialogDescription>
                    Споделете вашето мнение за продукта
                  </DialogDescription>
                </DialogHeader>
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          >
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue placeholder="Изберете рейтинг" />
                              </SelectTrigger>
                            </FormControl>
                            <SelectContent>
                ...
                <DialogFooter>
                  ...
                  >
                    {form.formState.isSubmitting ? "Добавяне..." : "Добави"}
                  </Button>
                </DialogFooter>
              </form>
            </Form>
      ...
      <div className="flex flex-col gap-3">
            ...
            <CardContent>
              <div className="flex space-x-4 text-sm text-muted-foreground">
                ...
                <div className="flex items-center">
                  ...
                  {review.user ? review.user.name : "Изтрит потребител"}
                </div>
                <div className="flex items-center">
        ...
        <div ref={ref}>{page < totalPages && "Зареждане..."}</div>
      </div>
    </div>
  );
}
